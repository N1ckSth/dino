...
class Ground():
	def __init__(self):
		self.image = pygame.image.load('D:/VS Code/algo projects/dino/Assets/ground.png')
	...
	def __init__(self, x, y):
		...
		for i in range(1, 4):
			img = pygame.image.load(
				f'D:/VS Code/algo projects/dino/Assets/Dino/{i}.png')
		...
		self.dead_image = pygame.image.load(
			f'D:/VS Code/algo projects/dino/Assets/Dino/8.png')
...
class Cactus(pygame.sprite.Sprite):
	def __init__(self, type):
		...
		for i in range(5):
			scale = 0.65
			img = pygame.image.load(
				f'D:/VS Code/algo projects/dino/Assets/Cactus/{i+1}.png')
			w, h = img.get_size()
...
class Ptera(pygame.sprite.Sprite):
	def __init__(self, x, y):
		...
		for i in range(2):
			scale = 0.65
			img = pygame.image.load(
				f'D:/VS Code/algo projects/dino/Assets/Ptera/{i+1}.png')
			w, h = img.get_size()
			img = pygame.transform.scale(img, (int(w*scale), int(h*scale)))
			self.image_list.append(img)
...
class Cloud(pygame.sprite.Sprite):
	def __init__(self, x, y):
		...
		self.image = pygame.image.load(
			f'D:/VS Code/algo projects/dino/Assets/cloud.png')
...
class Star(pygame.sprite.Sprite):
	def __init__(self, x, y, type):
		...
		image = pygame.image.load(f'D:/VS Code/algo projects/dino/Assets/stars.png')
		self.image_list = []
		for i in range(3):
